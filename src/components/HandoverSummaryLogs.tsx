        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-xl sm:text-2xl font-black tracking-tight text-white flex items-center gap-2">
              ...
              {shiftInfo.isLocked ? (
                <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-emerald-950 text-emerald-300 border border-emerald-700 flex items-center gap-1">
                  <Lock className="w-3 h-3" /> Locked & Confirmed
                </span>
              ) : (
                <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-amber-950 text-amber-300 border border-amber-700 flex items-center gap-1">
                  <Unlock className="w-3 h-3" /> Pending Handover Confirmation
                </span>
              )}
            </h2>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              onClick={handlePrint}
              className="px-3.5 py-2 rounded-xl text-xs font-bold bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition-colors flex items-center gap-1.5 cursor-pointer min-h-[44px]"
            >
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-bold flex items-center gap-2 shadow-lg transition-all cursor-pointer min-h-[44px] ${
                shiftInfo.isLocked
